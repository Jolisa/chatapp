...
public class ChatAppReceiver implements IChatAppReceiver {
	 ...
	 */
	public ChatAppReceiver(IChatRoomConnector _room, IChatAppConnector _userStub, ICmdToModelAdapter _c2mAdpt,
			ChatAppDataPacketAlgo visitor) {
		//this.room = _room;
		// make a deep copy of this chatroom with UUID
		room = new ChatRoomConnector(_room.getChatRoomName(), _room.getID());
